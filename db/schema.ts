...
export const simulationRuns = sqliteTable('simulation_runs', {
  ...
  promptTemplateId: text('prompt_template_id'), promptName: text('prompt_name'), userPrompt: text('user_prompt'), agentPrompt: text('agent_prompt'), guardianSpec: text('guardian_spec'), notes: text('notes'),
});
